...
public abstract class SegmentAbstract implements Serializable, Cloneable
{
    ...
    */
    public double getEnd() {        
        ...
        double end = ppN2Inspired /0.79 - MvplanInstance.getMvplan().getPrefs().getPAmb();
    ...
    {   
        ...
        return String.format("%1$3.0f"+MvplanInstance.getMvplan().getPrefs().getDepthShortString()+" - %2$02d:%3$02dmin, %4$s @%5$3.1f",
              depth, timeMins, timeSeconds ,  strgas, setpoint);
