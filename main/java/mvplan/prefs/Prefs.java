...
public class Prefs implements Serializable
{
    ...
    public void setDefaultPrefs()
    {
        ...
        defSetPoint = 0;
        prefSegments.add(new SegmentDive(30.0,20.0,(Gas)prefGases.get(0),defSetPoint));
        maxDepth=120.0;         // Default maximums
    ...
    public double getDefSetPoint() {return defSetPoint;}
    //proxy configuration
    ...
    public void setDefSetPoint(double setpoint)        {defSetPoint = setpoint;    }
    public void setSPDefDefSegement(){
        SegmentAbstract defseg = prefSegments.get(0);
        defseg.setSetpoint(defSetPoint);
        prefSegments.set(0,defseg);
    }
